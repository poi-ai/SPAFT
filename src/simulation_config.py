...
TARGET_DATE = ['2024-06-07','2024-06-10','2024-06-11','2024-06-12','2024-06-13','2024-06-14','2024-06-17','2024-06-18','2024-06-19','2024-06-20','2024-06-21']
...
LOSS_CUT_BORDER = [i for i in range(2,11)]

# 利確/損切後の再注文(利確/損切り額の何pips下に入れるか)
REORDER_LINE = [i for i in range(1,5)]
